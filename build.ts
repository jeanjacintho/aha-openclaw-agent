...
for (const name of ["boot/agent-index", "boot/config", "boot/identity", "boot/prompt", "boot/main", "boot/process", "boot/probe", "boot/probe-fixture", "boot/mcp-bridge", "plugin/index", "plugin/transport", "aha/worker", "aha/usage/ledger", "aha/usage/openclaw-export", "aha/usage/ledger-export"]) {
